...
Below we map and chart the top 6 EVTs, with the plantation and ruderal forest type lumped together.  These types cumulatively add up to more than 90% of the landscape.
...
```{r evt chart, echo=FALSE, message=FALSE, warning=FALSE, fig.width=11, fig.height=5}
...
*See chart below for colors/legend.*
<br>

```{r evc chart, echo=FALSE, message=FALSE, warning=FALSE, fig.width=10, fig.height=9}
...
```{r evh chart, echo=FALSE, message=FALSE, warning=FALSE, fig.width=10, fig.height=9}
...
To download full BpS description of this type click [here.](highlands_top3_bpss/13150_48_53_57_59_61.docx)
...
* Classes A, B and C are substantially underrepresented on today's landscape compared to the past.
* Current amount of class D is relatively close to reference amount.
* Class D is substantially over-represented opn the landscape today compared to the past.